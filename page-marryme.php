    ...
    <div class="grid">
      <div class="grid-item">
        <div class="card">
          <a href="<?php the_field('paket1') ?>" data-fancybox="responsive">
            ...
            <img class="card-img" src="<?php the_field('paket2') ?>" alt="Image 1" />
          </a>
      ...
      <div class="grid-item">
        <a href="<?php the_field('paket3') ?>" data-fancybox="responsive">
          ...
          <img class="card-img" src="<?php the_field('paket3') ?>" alt="Image 1" />
        </a>
      ...
      <div class="grid-item">
        <a href="<?php the_field('paket4') ?>" data-fancybox="responsive">
          ...
          <img class="card-img" src="<?php the_field('paket4') ?>" alt="Image 1" />
        </a>
